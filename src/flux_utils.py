...
def flux_optim(pils_source, pils_target, text_prompt, optim_iters, pils_sde=None): 
    ...
    def display_latent(latent):
        ...
        #breakpoint() # image torch.Size([1, 3, 512, 512])
    ...
    for img_input, img_target in zip(pils_source, pils_target):
        ...
        with torch.enable_grad():
            ...
            for iter in range( optim_iters ):
                ...
                loss_0 = torch.norm(V.float() - latents_target_loss.detach().float())
                #loss_0 = 0
                ...
                print(f'iter {iter}, loss_0 {loss_0}, loss_1 {loss_1}, loss_2 {loss_2}')
