...
BASE_PATH_BLUR="/home/zy3724/git_repos/flatten/metric_dataset/celebmetric/celeb_subset_blur"
BASE_PATH_BLEND="/home/zy3724/git_repos/flatten/metric_dataset/celebmetric/celeb_subset_blur_enhanced"
RESULTS_PATH="/home/zy3724/git_repos/flatten/metric_dataset/celebmetric/celeb_subset_blur_output"
PROMPT_INPUT="human"
IDX=60
...
for image_file in "$BASE_PATH_BLUR"/*.png; do
  ...
  python aceleb_script4bash_blur.py --file_path_blur "$FILE_PATH_BLUR" --file_path_blend "$FILE_PATH_BLEND" --prompt_input "$PROMPT_INPUT" --idx "$IDX" --save_path "$SAVE_PATH"
