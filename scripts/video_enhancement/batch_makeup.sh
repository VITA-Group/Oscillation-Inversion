...
BASE_PATH_BLUR="/home/zy3724/git_repos/flatten/video_samples/redwomen/source"
BASE_PATH_BLEND="/home/zy3724/git_repos/flatten/video_samples/redwomen/doodle"
RESULTS_PATH="/home/zy3724/git_repos/flatten/video_samples/redwomen/osci_result"
PROMPT_INPUT="a women with red eye shadow and red eye ring, high quality, 4K"
IDX=60
...
#   # Skip files with index less than 10
...
#   fi
  ...
  python avideo_script4bash_makeup.py --file_path_blur "$FILE_PATH_BLUR" --file_path_blend "$FILE_PATH_BLEND" --prompt_input "$PROMPT_INPUT" --idx "$IDX" --save_path "$SAVE_PATH"
